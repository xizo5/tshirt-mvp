...
mf = io.open(os.path.join(A, "male.b64"), encoding="ascii").read().strip()
mb = io.open(os.path.join(A, "male_back.b64"), encoding="ascii").read().strip()
ff = io.open(os.path.join(A, "female.b64"), encoding="ascii").read().strip()
fb = io.open(os.path.join(A, "female_back.b64"), encoding="ascii").read().strip()

with io.open(p, "r", encoding="utf-8") as f:
    lines = f.readlines()

new_imgs = [
    '<img id="baseMaleFront" src="data:image/jpeg;base64,' + mf + '" style="display:none">\n',
    '<img id="baseMaleBack" src="data:image/jpeg;base64,' + mb + '" style="display:none">\n',
    '<img id="baseFemaleFront" src="data:image/jpeg;base64,' + ff + '" style="display:none">\n',
    '<img id="baseFemaleBack" src="data:image/jpeg;base64,' + fb + '" style="display:none">\n',
]
out = []
img_done = 0
for ln in lines:
